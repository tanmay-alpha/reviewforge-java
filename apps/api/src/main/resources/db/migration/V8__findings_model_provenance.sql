-- ============================================
-- V8: record model provenance on findings
-- ============================================
...
-- that produced it. These are filled from the MlReviewResponse
-- envelope on every review.

ALTER TABLE findings
    ADD COLUMN IF NOT EXISTS engine VARCHAR(60);

ALTER TABLE findings
    ADD COLUMN IF NOT EXISTS model_version VARCHAR(40);

ALTER TABLE findings
    ADD COLUMN IF NOT EXISTS taxonomy_version VARCHAR(40);
